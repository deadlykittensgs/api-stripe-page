...
app.post('/create-checkout-session/:product', async (req, res) => {
    ...
    if (product === 'sub') {
        price_ID = 'price_1PW2xjH8WKJ9WglbB2N1cdhb'
        mode = 'subscription'
        line_items = [
            {
                price: price_ID,
        ...
        price_ID = 'price_1PW2sxH8WKJ9Wglb7tzX0z8Z'
        mode = 'payment'
        line_items = [
            {
                price: price_ID,
...
// use webhook to access firebase entry for that api key and ensure that billing info is updated accordingly 
